...
export class Renderer {
  constructor(canvas, board) {
    ...
    // shadow map every frame by default, drawing every caster in the scene a SECOND time - and
    // this machine is a still life whenever nothing is moving, which is most of a rack while the
    // player lines up. render() sets needsUpdate for exactly the frames a caster moved (see the
    // bottom of render()). Ported from BRICK CITY, where it was measured at 172 draw calls per
    // frame with the pass on against 138 with it off.
