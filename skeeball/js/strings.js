...
const STRINGS = {
  en: {
    ...
    // Challenges (2026-09-24): one rack each, the higher score wins
    ch_btn: 'Challenge',
    ch_badge_aria: '{n} waiting on you',
    ch_title: 'Challenges',
    ch_new: 'New challenge',
    ch_back: 'Back',
    ch_loading: 'Loading...',
    ch_none: 'No challenges yet. Send one!',
    ch_sec_play: 'Your turn',
    ch_sec_sent: 'Waiting on them',
    ch_sec_done: 'Results',
    ch_someone: 'Someone',
    ch_beat: 'Beat {n}',
    ch_you_scored: 'You scored {n}',
    ch_row_won: 'You won',
    ch_row_lost: 'You lost',
    ch_row_draw: 'Tie',
    ch_expired: 'Expired',
    ch_expired_long: 'This challenge ran out of time.',
    ch_days_left: '{n}d left',
    ch_hours_left: '{n}h left',
    ch_pick: 'Who do you want to challenge?',
    ch_no_players: 'Nobody to challenge yet.',
    ch_to: 'Challenge {name}',
    ch_machine: 'Machine',
    ch_no_machine: 'You two have no machine in common yet.',
    ch_caption: 'Say something (optional)',
    ch_caption_ph: 'Beat that!',
    ch_terms_note: 'One game per turn: you play, then {name} plays that game seeing your score, and so on. Leaving a game counts your score as it stands. 3 days per turn.',
    ch_from: '{name} challenged you',
    ch_one_rack: 'One attempt. Leaving the game ends it and counts your score as it stands.',
    ch_queued: 'Your score is saved and will be sent.',
    ch_hud_beat: 'Beat {n}',
    ch_hud_vs: 'vs {name}',
    ch_sending: 'Sending...',
    ch_sent_h: 'Challenge sent',
    ch_sent_note: '{name} has 3 days to play it.',
    ch_turn_passed: "{name}'s turn. They have 3 days to play.",
    ch_sent_score: 'Your score was sent.',
    ch_saved_later: 'No connection. Your score is saved and will send later.',
    ch_err_send: 'Could not send. Check your connection and try again.',
    ch_err_off: 'Challenges are not switched on yet.',
    ch_err_dev: 'Sending is off on this test server.',
    ch_err_answered: 'This challenge was already answered.',
    ch_won: 'You won!',
    ch_lost: 'You lost',
    ch_draw: 'It\'s a tie',
    ch_you: 'You',
    ch_rematch: 'Rematch',
    ch_all: 'All challenges',
    ch_done: 'Done',
    ch_one_game: '1 game',
    ch_n_games: '{n} games',
    ch_all_machines: 'All machines',
    ch_format: 'Format',
    ch_scoring: 'Winner',
    ch_sc_games: 'Most wins',
    ch_sc_total: 'Total score',
    ch_machines: 'Machines',
    ch_total: 'Total',
    ch_games_won: 'Games won',
    ch_start: 'Start',
    ch_starting: 'Starting...',
    ch_err_start: 'Could not start. Check your connection and try again.',
    ch_err_read: 'Could not load this challenge. Check your connection.',
    ch_yours_to: 'Your challenge to {name}',
    ch_waiting: 'Waiting on them',
    ch_waiting_on: 'Waiting on {name}.',
    ch_your_games: '{p} of {n} played',
    ch_play_n: 'Play game {k} of {n}: {m}',
    ch_game_k: 'Game {k} of {n}',
  },
  ...
  es: {
    ...
    ch_btn: 'Retar',
    ch_badge_aria: '{n} esperando tu turno',
    ch_title: 'Retos',
    ch_new: 'Nuevo reto',
    ch_back: 'Atrás',
    ch_loading: 'Cargando...',
    ch_none: 'Aún no hay retos. ¡Envía uno!',
    ch_sec_play: 'Te toca',
    ch_sec_sent: 'Esperando al otro',
    ch_sec_done: 'Resultados',
    ch_someone: 'Alguien',
    ch_beat: 'Supera {n}',
    ch_you_scored: 'Hiciste {n}',
    ch_row_won: 'Ganaste',
    ch_row_lost: 'Perdiste',
    ch_row_draw: 'Empate',
    ch_expired: 'Caducado',
    ch_expired_long: 'Este reto se quedó sin tiempo.',
    ch_days_left: 'quedan {n} d',
    ch_hours_left: 'quedan {n} h',
    ch_pick: '¿A quién quieres retar?',
    ch_no_players: 'Todavía no hay nadie a quien retar.',
    ch_to: 'Retar a {name}',
    ch_machine: 'Máquina',
    ch_no_machine: 'Aún no tenéis ninguna máquina en común.',
    ch_caption: 'Di algo (opcional)',
    ch_caption_ph: '¡Supera eso!',
    ch_terms_note: 'Una partida por turno: juegas tú, luego {name} juega esa partida viendo tu puntuación, y así. Si sales, cuenta tu puntuación tal como esté. 3 días por turno.',
    ch_from: '{name} te ha retado',
    ch_one_rack: 'Un intento. Si sales del juego, termina y cuenta tu puntuación tal como esté.',
    ch_queued: 'Tu puntuación está guardada y se enviará.',
    ch_hud_beat: 'Supera {n}',
    ch_hud_vs: 'contra {name}',
    ch_sending: 'Enviando...',
    ch_sent_h: 'Reto enviado',
    ch_sent_note: '{name} tiene 3 días para jugarlo.',
    ch_turn_passed: 'Le toca a {name}. Tiene 3 días para jugar.',
    ch_sent_score: 'Tu puntuación se ha enviado.',
    ch_saved_later: 'Sin conexión. Tu puntuación está guardada y se enviará más tarde.',
    ch_err_send: 'No se pudo enviar. Revisa tu conexión e inténtalo de nuevo.',
    ch_err_off: 'Los retos aún no están activados.',
    ch_err_dev: 'El envío está desactivado en este servidor de pruebas.',
    ch_err_answered: 'Este reto ya tenía respuesta.',
    ch_won: '¡Ganaste!',
    ch_lost: 'Perdiste',
    ch_draw: 'Empate',
    ch_you: 'Tú',
    ch_rematch: 'Revancha',
    ch_all: 'Todos los retos',
    ch_done: 'Hecho',
    ch_one_game: '1 partida',
    ch_n_games: '{n} partidas',
    ch_all_machines: 'Todas las máquinas',
    ch_format: 'Formato',
    ch_scoring: 'Gana',
    ch_sc_games: 'Más victorias',
    ch_sc_total: 'Puntuación total',
    ch_machines: 'Máquinas',
    ch_total: 'Total',
    ch_games_won: 'Partidas ganadas',
    ch_start: 'Empezar',
    ch_starting: 'Empezando...',
    ch_err_start: 'No se pudo empezar. Revisa tu conexión e inténtalo de nuevo.',
    ch_err_read: 'No se pudo cargar este reto. Revisa tu conexión.',
    ch_yours_to: 'Tu reto a {name}',
    ch_waiting: 'Esperando al otro',
    ch_waiting_on: 'Esperando a {name}.',
    ch_your_games: '{p} de {n} jugadas',
    ch_play_n: 'Jugar partida {k} de {n}: {m}',
    ch_game_k: 'Partida {k} de {n}',
  },
};
