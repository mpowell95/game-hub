...
const STRINGS = {
  en: {
    ...
    ch_terms_note: 'Play one rack. If you like your score, send it. {name} gets 3 days to beat it.',
    ch_play_rack: 'Play your rack',
    ch_from: '{name} challenged you',
    ch_to_beat: 'Score to beat',
    ch_one_rack: 'One rack. Leaving the game ends it and sends your score.',
    ch_queued: 'Your score is saved and will be sent.',
    ch_hud_beat: 'Beat {n}',
    ch_hud_vs: 'vs {name}',
    ch_send_q: 'Send this score to {name}? They get 3 days to beat it.',
    ch_send: 'Send to {name}',
    ch_try_again: 'Try again',
    ch_sending: 'Sending...',
    ch_sent_h: 'Challenge sent',
    ch_sent_note: '{name} has 3 days to beat {n}.',
  ...
  es: {
    ...
    ch_terms_note: 'Juega una partida. Si te gusta tu puntuación, envíala. {name} tendrá 3 días para superarla.',
    ch_play_rack: 'Jugar tu partida',
    ch_from: '{name} te ha retado',
    ch_to_beat: 'Puntuación a superar',
    ch_one_rack: 'Una partida. Si sales del juego, termina y se envía tu puntuación.',
    ch_queued: 'Tu puntuación está guardada y se enviará.',
    ch_hud_beat: 'Supera {n}',
    ch_hud_vs: 'contra {name}',
    ch_send_q: '¿Enviar esta puntuación a {name}? Tendrá 3 días para superarla.',
    ch_send: 'Enviar a {name}',
    ch_try_again: 'Intentar de nuevo',
    ch_sending: 'Enviando...',
    ch_sent_h: 'Reto enviado',
    ch_sent_note: '{name} tiene 3 días para superar {n}.',
