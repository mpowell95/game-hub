...
const STRINGS = {
  en: {
    ...
    ch_terms_note: 'One attempt per game. Leaving a game counts your score as it stands. {name} gets 3 days once you finish.',
  ...
  es: {
    ...
    ch_terms_note: 'Un intento por partida. Si sales, cuenta tu puntuación tal como esté. {name} tendrá 3 días cuando termines.',
