...
const STRINGS = {
  en: {
    ...
    d_ra_hoop: 'Sink one 100 to set the other running, then catch it while it slides.',
  ...
  es: {
    ...
    d_ra_hoop: 'Mete un 100 para que el otro eche a correr, y atrapalo mientras se desliza.',
