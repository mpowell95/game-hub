...
export const VEHICLES = [
  {
    ...
    body: {
      ...
      power: 5200, reaction: 1150, airTorque: 30,
      grip: 1.05, fuel: 100,
  ...
  },
  {
    ...
    body: {
      ...
      power: 3700, reaction: 1050, airTorque: 38,
      grip: 0.98, fuel: 88,
      head: { x: -0.02, y: 1.06 },
      hull: { w: 1.7, h: 0.46 },
    },
  ...
  },
  {
    ...
    body: {
      ...
      power: 9200, reaction: 1900, airTorque: 27,
      grip: 1.18, fuel: 118,
      head: { x: -0.14, y: 1.16 },
      hull: { w: 2.8, h: 0.86 },
    },
  ...
  },
  {
    ...
    body: {
      ...
      power: 4700, reaction: 950, airTorque: 33,
      grip: 1.1, fuel: 140,
      head: { x: -0.10, y: 1.04 },
      hull: { w: 2.6, h: 0.56 },
    },
...
export function tunedSpec(vehicleId, upgrades, stage) {
  ...
  return {
    ...
    spring: b.spring * (1 + 0.13 * u.suspension),
    damp: b.damp * (1 + 0.20 * u.suspension),
