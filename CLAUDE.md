...
| Brick Blitz | in-hub `module:`, immersive, **solo score attack** (clone of Neon Breakout, 2026-09-23), **admin only** (`devOnly`) | `.bx-root` / `.bx-` | `gamehub.brickblitz.v1` | `recordBrickBlitz` |
