...
export const STRINGS = {
  en: {
    ...
    hand_l: 'L',
    hand_r: 'R',
    preset_twoWayStar: 'Two-Way Star',
    preset_tableSetter: 'Table Setter',
    preset_slugger: 'Slugger',
    preset_speedster: 'Speedster',
    preset_flamethrower: 'Flamethrower',
    preset_junkballer: 'Junkballer',
    preset_painter: 'Painter',
  ...
  es: {
    ...
    hand_l: 'L',
    hand_r: 'R',
    preset_twoWayStar: 'Estrella Dual',
    preset_tableSetter: 'Generador',
    preset_slugger: 'Slugger',
    preset_speedster: 'Velocista',
    preset_flamethrower: 'Lanzallamas',
    preset_junkballer: 'Junkballer',
    preset_painter: 'Pintor',
    preset_custom: 'Personalizado',
    preset_random: 'Aleatorio',
