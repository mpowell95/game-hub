/* Baseball mocks - the Swing/Throw ring, drawn once and reused by the play-screen
   control band and by button-states.html so both stay the same drawing.
   Mock only: real geometry values (137px ring, 10px thickness, 101px button, arc math)
   are lifted straight out of the Design Spec so the picture matches the numbers. */
