...
export const STRINGS = {
  en: {
    ...
    vsName: 'vs {name}', mpSecYours: 'Your turn', mpSecTheirs: 'Waiting on them', mpWaiting2: 'Waiting',
    ...
    cerVs: 'VS',
    cerGo: 'Let\u2019s play', cerGoTurn: 'Take my shot', cerLater: 'Not now', cerSkip: 'Skip',
    ...
    youWin: 'You won', youLose: 'You lost', gameOver: 'Game over', seeBoard: 'See the board', ok: 'OK', vsName2: 'vs {name}', nMore: '+{n} more', redWins: 'Red wins', yellowWins: 'Yellow wins',
    draw: 'Draw',
    accuracy: 'Accuracy',
  ...
  es: {
    ...
    vsName: 'contra {name}', mpSecYours: 'Te toca', mpSecTheirs: 'Esperando al rival', mpWaiting2: 'Esperando',
    ...
    cerVs: 'VS',
    cerGo: 'A jugar', cerGoTurn: 'Tirar', cerLater: 'Ahora no', cerSkip: 'Saltar',
    ...
    youWin: 'Ganaste', youLose: 'Perdiste', gameOver: 'Fin de la partida', seeBoard: 'Ver el tablero', ok: 'OK', vsName2: 'contra {name}', nMore: '+{n} m\u00e1s', redWins: 'Gana Rojo', yellowWins: 'Gana Amarillo',
    draw: 'Empate',
    accuracy: 'Puntería',
