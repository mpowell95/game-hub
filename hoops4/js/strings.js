...
export const STRINGS = {
  en: {
    ...
    howtoEg: 'Sink hoop 3 = your disc drops down column 3.',
    howtoArc: 'Swipe harder for a higher arc.',
    howtoAim: 'The angle picks the hoop.',
    howtoRim: 'Rim out into the next hoop? It counts for that one.',
    close: 'Close',
  ...
  es: {
    ...
    howtoEg: 'Encesta en la 3 = tu ficha cae por la columna 3.',
    howtoArc: 'Desliza más fuerte para un arco más alto.',
    howtoAim: 'El ángulo elige la canasta.',
    howtoRim: '¿Rebota a la de al lado? Cuenta para esa.',
    close: 'Cerrar',
