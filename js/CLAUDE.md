...
| `js/net.js` | multiplayer room layer (`rooms/<CODE>`, lockstep move log, heartbeat, recovery, SW-version match on join) used by Chinchón, Escoba, Tic Tac Toe, Mancala and Dots and Boxes |
...
Chinchón, Escoba, Tic Tac Toe, Mancala and Dots and Boxes share one lockstep protocol over `js/net.js`
...
### The fifth consumer: Dots and Boxes (2026-07-27, roadmap phase 2)
