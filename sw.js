...
const ASSETS = [
  ...
  './skeeball/js/challenge.js',
  './skeeball/js/challenge-ui.js',
  './skeeball/js/alert.js',
  ...
  './baseball/js/engine/liveplay.js',
...
const REST_MANIFEST = {
  ...
  './minesweeper/css/minesweeper.css': '3f64fe8555',
  ...
  './hoops4/js/boarddef.js': 'f1add756ee',
  './hoops4/js/machine.js': 'cdb79c9ceb',
  './hoops4/js/physics.js': 'bc8b1a2624',
  './hoops4/js/render.js': '86329fcb53',
  ...
  './baseball/css/baseball.css': 'effe85fa89',
  './baseball/js/ui.js': 'f59ed297fa',
  './baseball/js/field.js': 'c79a1b9f80',
  './baseball/js/ring.js': '4786e4ea61',
  './baseball/js/strings.js': '470cd0b436',
  ...
  './baseball/models/player.glb': '259fc6aea6',
  './baseball/models/skins/skaterMaleA.png': 'cabeed9d1b',
