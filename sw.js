...
const REST_MANIFEST = {
  ...
  './pinball/js/table-design.js': 'd86f7c6328',
  './pinball/js/design.js': 'cd4b48aee3',
  './pinball/js/render-design.js': 'de79b85569',
  './pinball/design/board.js': '3c7c96e801',
  './pinball/design/editor.html': '5372480eab',
  ...
  './golf/css/golf.css': 'ac817f72ab',
  './golf/js/ui.js': '31fc760154',
  './golf/js/strings.js': '6a412670f7',
  './golf/js/holes.js': 'e698c54e72',
  './golf/js/club-art.js': '777bcfb097',
  './golf/js/clubs.js': 'b020ff95b5',
  './golf/js/swing.js': 'b390f25308',
  './golf/js/shot.js': '0984fd290b',
  './golf/js/render.js': 'a4e8ba9280',
  './golf/js/holegen.js': '93428994c1',
  './golf/js/rounds.js': '9b7f566d8e',
  './golf/js/progress.js': 'ac0e7f0d2c',
  './golf/js/tutorial.js': 'ab93ba9178',
