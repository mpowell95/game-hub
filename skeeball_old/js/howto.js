...
export function howToHtml() {
  return `
    <div class="sko-ht-scrim" hidden>
      <div class="sko-ht" role="dialog" aria-modal="true" aria-label="${t('ht_title')}">
        <h2 class="sko-ht-title">${t('ht_title')}</h2>
        <div class="sko-ht-card">
          <div class="sko-ht-panel">
            <canvas class="sko-ht-canvas" data-role="art"></canvas>
            <svg class="sko-ht-hand" data-role="hand" viewBox="0 0 40 52" aria-hidden="true">
          ...
          <p class="sko-ht-caption" data-role="caption"></p>
        </div>
        <div class="sko-ht-dots" data-role="dots">
          ${PAGES.map((p, i) => `<span class="sko-ht-dot${i === 0 ? ' is-on' : ''}"></span>`).join('')}
        </div>
        <div class="sko-ht-foot">
          <button type="button" class="sko-ht-btn sko-ht-end" data-role="first" aria-label="${t('ht_first')}">|◀</button>
          <button type="button" class="sko-ht-btn sko-ht-ok" data-role="close">${t('ht_ok')}</button>
          <button type="button" class="sko-ht-btn sko-ht-end" data-role="next" aria-label="${t('ht_next')}">▶|</button>
        </div>
      </div>
    </div>`;
}
...
export function createHowTo(host, boardId) {
  const scrim = host.querySelector('.sko-ht-scrim');
  ...
  const dots = [...host.querySelectorAll('.sko-ht-dot')];
