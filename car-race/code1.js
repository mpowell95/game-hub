...
gdjs.LevelSelectionCode.localVariables = [];
gdjs.LevelSelectionCode.idToCallbackMap = new Map();
...
{for(var i = 0, len = gdjs.LevelSelectionCode.GDLevelButtonObjects1.length ;i < len;++i) {
    gdjs.LevelSelectionCode.GDLevelButtonObjects1[i].SetLabelText("Level " + gdjs.LevelSelectionCode.GDLevelButtonObjects1[i].getVariables().getFromIndex(0).getAsString(), null);
}
}
}
...
for (var i = 0, k = 0, l = gdjs.LevelSelectionCode.GDLevelButtonObjects1.length;i<l;++i) {
    if ( gdjs.LevelSelectionCode.GDLevelButtonObjects1[i].IsClicked(null) ) {
...
{runtimeScene.getGame().getVariables().getFromIndex(0).setNumber(((gdjs.LevelSelectionCode.GDLevelButtonObjects1.length === 0 ) ? gdjs.VariablesContainer.badVariablesContainer : gdjs.LevelSelectionCode.GDLevelButtonObjects1[0].getVariables()).getFromIndex(0).getAsNumber());
}
...
for (var i = 0, k = 0, l = gdjs.LevelSelectionCode.GDRandomButtonObjects1.length;i<l;++i) {
    if ( gdjs.LevelSelectionCode.GDRandomButtonObjects1[i].IsClicked(null) ) {
        isConditionTrue_0 = true;
