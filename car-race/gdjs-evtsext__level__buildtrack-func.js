...
gdjs.evtsExt__Level__BuildTrack.idToCallbackMap = new Map();
...
gdjs.evtsExt__Level__BuildTrack.mapOfGDgdjs_9546evtsExt_9595_9595Level_9595_9595BuildTrack_9546GDStartIndicatorObjects1Objects = Hashtable.newFrom({"StartIndicator": gdjs.evtsExt__Level__BuildTrack.GDStartIndicatorObjects1});
gdjs.evtsExt__Level__BuildTrack.mapOfGDgdjs_9546evtsExt_9595_9595Level_9595_9595BuildTrack_9546GDRoadTileObjects1Objects = Hashtable.newFrom({"RoadTile": gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1});
...
{
{runtimeScene.getScene().getVariables().get("x").setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("StartX")) + gdjs.evtsExt__CurvedMovement__PathEndX.func(runtimeScene, "" + eventsFunctionContext.getArgument("PathName"), eventsFunctionContext));
}
{runtimeScene.getScene().getVariables().get("y").setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("StartY")) + gdjs.evtsExt__CurvedMovement__PathEndY.func(runtimeScene, "" + eventsFunctionContext.getArgument("PathName"), eventsFunctionContext));
}
...
{gdjs.evtsExt__CurvedMovement__AppendPath.func(runtimeScene, eventsFunctionContext.getArgument("PathName"), (( gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3.length === 0 ) ? "" :gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3[0].getBehavior(eventsFunctionContext.getBehaviorName("RoadTileBehavior")).PathName(eventsFunctionContext)), eventsFunctionContext);
}
...
if (isConditionTrue_0) {
/* Reuse gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3 */
{gdjs.evtsExt__CurvedMovement__AppendPath.func(runtimeScene, eventsFunctionContext.getArgument("PathName"), (( gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3.length === 0 ) ? "" :gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3[0].getBehavior(eventsFunctionContext.getBehaviorName("RoadTileBehavior")).InvertedPathName(eventsFunctionContext)), eventsFunctionContext);
}
{for(var i = 0, len = gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3.length ;i < len;++i) {
    gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3[i].setVariableBoolean(gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects3[i].getVariables().get("covered"), true);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.evtsExt__Level__BuildTrack.mapOfGDgdjs_9546evtsExt_9595_9595Level_9595_9595BuildTrack_9546GDStartIndicatorObjects1Objects, gdjs.evtsExt__Level__BuildTrack.mapOfGDgdjs_9546evtsExt_9595_9595Level_9595_9595BuildTrack_9546GDRoadTileObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1 */
/* Reuse gdjs.evtsExt__Level__BuildTrack.GDStartIndicatorObjects1 */
{runtimeScene.getScene().getVariables().get("StartX").setNumber((( gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1.length === 0 ) ? 0 :gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("RoadTileBehavior")).StartX(eventsFunctionContext)));
}
{runtimeScene.getScene().getVariables().get("StartY").setNumber((( gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1.length === 0 ) ? 0 :gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("RoadTileBehavior")).StartY(eventsFunctionContext)));
}
{gdjs.evtsExt__CurvedMovement__DuplicatedPath.func(runtimeScene, eventsFunctionContext.getArgument("PathName"), (( gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1.length === 0 ) ? "" :gdjs.evtsExt__Level__BuildTrack.GDRoadTileObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("RoadTileBehavior")).PathName(eventsFunctionContext)), eventsFunctionContext);
}
